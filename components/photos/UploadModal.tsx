        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="It was the night of the Crown Theatre trip, probably 1997. Chengachi bet everyone he could eat three biriyanis and then spent the night on the hostel roof…"
              rows={3}
